...
dataToEvaluate = []
readFiles("results/top100Completion.json", dataToEvaluate)
readFiles("results/top100Completion2.json", dataToEvaluate)
readFiles("results/top100Completion3.json", dataToEvaluate)
